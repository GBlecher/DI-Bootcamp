...
#     def log_song(self):
#         self.lyrics.append(self.lyrics)
...
class Zoo:
    ...
    def add_animal(self, new_animal):
        if new_animal not in self.animals:
            ...
            print(f"{self.zoo_name} already has a {new_animal}  ")
...
while True:
    animal = input("what animals should we add to the zoo? (Enter 'q' to quit):\t ").title()
    if animal == 'Q':
        break
